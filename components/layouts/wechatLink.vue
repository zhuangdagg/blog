<template>
    <div class="wechat-link">
        <div class="wechat-icon" v-html="svg"></div>
...
import wechat from '../../assets/capture/wechat.jpg'
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1.19em" height="1em" viewBox="0 0 2048 1728">
